# 🌙 Falling Dream (2D Platformer Exploration Game)

> A 2D side-scrolling, exploration-focused narrative platformer inspired by *Hollow Knight*. Developed from scratch in just two weeks.

🕹️ **[Play the Game directly in your browser!](https://earnest-sunburst-a93821.netlify.app/)** *(Note: The game contains high-quality art and audio assets. Please allow a moment for the initial loading. No PC configuration or installation is required.)*

🎬 **[Watch the Gameplay Showcase on Bilibili](https://www.bilibili.com/video/BV1xqXYYGEuF/)**

---

## 📖 About the Project

This project was developed as the final assignment for the **"Introduction to 2D Game Development"** course at **Xi'an Jiaotong University**, taught entirely in English by visiting professor **Kelvin Sung** , **2025.04** . 

Our team started with zero prior experience in Unity game development. Within a strict **two-week timeframe**, we successfully learned the engine, designed the mechanics, implemented the art, and delivered a fully playable game. The project received widespread recognition from our peers and was awarded an **A+ grade** for the course.

---

## 🛠️ Team Members & Contributions
...
* **Jiayi Li** * Scene & Main Menu Transition Framework
